...
APPLICATION='/ticketsampleapplication7812'
...
DESKTOPIMAGENAME='geppettotest/ticketsampleapplication7812-desktop:1.0'
...
helm install --name ticketsampleapplication7812-7762 ./helm
if [ $? -eq 0 ]; then
